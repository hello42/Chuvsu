 ...
 * interface.
 */
public class NewsCardFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new NewsCardAdapter(getActivity()));
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (null != mListener) {
            ...
            //mListener.onFragmentInteraction(DummyContent.ITEMS.get(position).title);
        }
    }
